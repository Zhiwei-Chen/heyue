<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="warehouseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="仓储方式" align="center" prop="storeType" :formatter="storeTypeFormat" />
      <el-table-column label="备注" align="center" prop="remark" />
      <el-table-column label="负责人" align="center" prop="userId" />
      <el-table-column label="传感器" align="center" prop="sensorIds" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="650px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="仓储方式" prop="storeType">
          <el-select v-model="form.storeType" placeholder="请选择仓储方式">
            <el-option
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.getDicts("warehouse_store_type").then(response => {
    ...
    methods: {
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除仓库信息编号为"' + ids + '"的数据项?', "警告", {
