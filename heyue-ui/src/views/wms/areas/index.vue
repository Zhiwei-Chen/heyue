  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="650px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="区域" prop="name">
          <el-input v-model="form.name" placeholder="请输入区域" />
        </el-form-item>
      </el-form>
...
<script>
import { listAreas, getAreas, delAreas, addAreas, updateAreas } from "@/api/wms/areas";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除仓库区域编号为"' + ids + '"的数据项?', "警告", {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('wms/areas/export', {
        ...this.queryParams
      }, `wms_areas.xlsx`)
    }
  }
