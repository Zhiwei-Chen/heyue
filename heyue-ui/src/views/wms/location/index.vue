<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="locationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="货位名称" align="center" prop="id" />
      ...
      <el-table-column label="尺寸" align="center" prop="space" />
      <el-table-column label="货位状态" align="center" prop="status" :formatter="statusFormat" />
      <el-table-column label="货位类型" align="center" prop="type" :formatter="typeFormat" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="650px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="货位编码" prop="code">
          <el-input v-model="form.code" placeholder="请输入货位编码" />
        </el-form-item>
        <el-form-item label="货位名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入货位名称" />
        </el-form-item>
        <el-form-item label="货位状态" prop="status">
          <el-select v-model="form.status" placeholder="请选择货位状态">
            <el-option
        ...
        <el-form-item label="货位类型" prop="type">
          <el-select v-model="form.type" placeholder="请选择货位类型">
            <el-option
...
<script>
  ...
  export default {
    ...
    created() {
      this.getList();
      this.getDicts("location_status").then(response => {
        this.statusOptions = response.data;
      });
      this.getDicts("location_type").then(response => {
    ...
    methods: {
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除货位信息编号为"' + ids + '"的数据项?', "警告", {
